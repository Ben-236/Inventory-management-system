    ...
    */
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
        var title, data, category, _createCategory;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if ((0, _Logger.validateMongoID)(req.params.id)) {
                  _context2.next = 3;
                  break;
                }
              ...
              case 3:
                _context2.prev = 3;
                _context2.next = 6;
                return _Category2.default.findByIdAndUpdate({ _id: req.params.id }, { title: title });

              case 6:
                _updateCategory = _context2.sent;
