...
categoryRouter.route('/update/:id').patch(_trimInputs2.default, (0, _validateInputs2.default)(_validationRules.categoryRules), _CategoryController2.default.updateCategory);
